...
for USER in $USERS; do
  ...
  [ ! -f /home/"$USER"/.ssh/id_rsa.pub ] && sudo -u "$USER" ssh-keygen -t rsa -N "" -f /home/"$USER"/.ssh/id_rsa
  [ ! -f /home/"$USER"/.ssh/id_ed25519.pub ] && sudo -u "$USER" ssh-keygen -t ed25519 -N "" -f /home/"$USER"/.ssh/id_ed25519
